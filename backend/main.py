...
async def lifespan(app: FastAPI):
    ...
    from backend.agents import subscription_account_monitor as _sam
    subscription_monitor_task = asyncio.create_task(_sam.run_monitor_loop())
...
from backend.routers import (  # OP-2243 BI4
    meeting_suggestions as _meeting_suggestions_router,
)
_include_versioned_router(_meeting_suggestions_router.router)
...
from backend.routers import learned_items as _learned_items_router  # β-3c leg-2
_include_versioned_router(_learned_items_router.router)
from backend.routers import claude_memories as _claude_memories_router  # γ-0 leg-3
...
from backend.routers import runbooks as _runbooks_router  # OP-1502 WP.8 runbook primitive
_include_versioned_router(_runbooks_router.router)
...
from backend.routers import action_challenges as _action_challenges_router  # OP-2671 hardened human challenge decisions
_include_versioned_router(_action_challenges_router.router)
