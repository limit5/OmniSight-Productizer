...
def test_release_status_registered_and_in_observe_set():
    ...
    # NOTE: behavioural coverage for supervisor_release_status (deployed version +
    # pending proposals, per-section fail-open) lives in test_sora_p5_execute.py —
    # the tool was rewritten off release_dashboard (greenlet bug) onto
    # api_versioning.get_deploy_overlay + the proposed_actions async pool.
