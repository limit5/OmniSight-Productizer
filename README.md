...
![Tests](https://img.shields.io/badge/Tests-734-brightgreen)
...
│   └── ...
├── configs/
│   ├── platforms/          # 13 platform profiles (embedded: aarch64, armv7, riscv64, vendor-example, host_native; web: static, ssr-node, edge-cloudflare, vercel; mobile: ios-arm64, ios-simulator, android-arm64-v8a, android-armeabi-v7a)
