...
## Lesson 24 — Gerrit webhooks plugin v3.13.5 has zero auth surface; OP-689 daemon never deployed (2026-05-07)
...
## Lesson 26 — Runner git operations need layered cleanup for stuck rebase state (2026-05-08)
...
## Lesson 31 — Test-impact analysis must fail closed on the conservative side (2026-05-08)
