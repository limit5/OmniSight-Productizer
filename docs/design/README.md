...
| [2026-05-18-rpg-w21-boss-task-design.md](2026-05-18-rpg-w21-boss-task-design.md) | RPG.W21 quarterly boss-task (large-refactor raid) — trigger, eligibility, time-gate, reward, proposed schema, proposed API surface, UI placeholder, operator open questions; wraps W21.1/W21.2/W21.3 primitives; design-only (OP-1462) | Priority RPG (W21) |
