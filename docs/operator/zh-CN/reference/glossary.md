...
- [ADR-0008 — Agent RPG Class & Skill Leveling System](../../../adr/0008-agent-rpg-class-skill-leveling.md) — agent 角色卡 / Guild / level / skill / talent 模型的权威规格（操作面 how-to：[`docs/operations/agent-rpg-system.md`](../../../operations/agent-rpg-system.md)）
