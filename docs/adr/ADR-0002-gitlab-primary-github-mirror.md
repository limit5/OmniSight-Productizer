---
id: ADR-0002
title: GitLab self-hosted primary, GitHub one-way mirror, Gerrit review layer
status: Accepted
date: 2026-05-04
---
...
3. **Multi-AI governance** (per [ADR 0001](ADR-0001-five-branch-gitflow.md) + [ADR 0003](ADR-0003-gerrit-code-review.md)) needs Gerrit-style fine-grained review scoring, which GitHub PR approvals don't natively support.
...
| Issues | JIRA Cloud (Atlassian) | not GitLab Issues — see [ADR 0004](ADR-0004-per-agent-jira-identity.md) |
...
| Code review | Gerrit | not GitLab MR — see [ADR 0003](ADR-0003-gerrit-code-review.md) |
...
- [ADR 0001 — Five-branch Git Flow](ADR-0001-five-branch-gitflow.md) — defines the branches that live on these remotes
- [ADR 0003 — Gerrit code review](ADR-0003-gerrit-code-review.md) — defines how Gerrit pulls from GitLab
