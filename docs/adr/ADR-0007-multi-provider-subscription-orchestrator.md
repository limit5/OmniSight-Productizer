---
id: ADR-0007
title: Multi-Provider Subscription Orchestrator + Cost Calculator
status: Accepted
date: 2026-05-06
---
...
- [ADR 0001 — Five-branch Git Flow](ADR-0001-five-branch-gitflow.md) — v0.4.0 milestone cut from develop
- [ADR 0005 — Tier S/M/L/X authority](ADR-0005-tier-authority-levels.md) — agent_class labels feed orchestrator routing
- [ADR 0008 — Agent RPG class & skill leveling](ADR-0008-agent-rpg-class-skill-leveling.md) — shares `agent_class` schema (MP.W0 source of truth); MP.W17 (upfront tool baseline) ↔ RPG.W13 (runtime proficiency leveling) are static/adaptive complements
