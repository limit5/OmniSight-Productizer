---
id: ADR-0006
title: TLS Termination at Synology DSM Reverse Proxy + Sectigo Wildcard Cert
status: Accepted
date: 2026-05-05
---
...
[ADR 0002](ADR-0002-gitlab-primary-github-mirror.md) decided GitLab self-hosted is the primary code repo + Gerrit is the review layer (per [ADR 0003](ADR-0003-gerrit-code-review.md)). Both run on the same Synology NAS at `sora.services`. Phase 0 baseline (2026-05-05) ran all three services on plain HTTP:
...
- [ADR 0002 — GitLab primary + GitHub mirror + Gerrit review](ADR-0002-gitlab-primary-github-mirror.md) — the architecture this ADR's TLS layer protects
- [ADR 0003 — Gerrit code review](ADR-0003-gerrit-code-review.md) — Gerrit canonicalWebUrl + listenUrl semantics
