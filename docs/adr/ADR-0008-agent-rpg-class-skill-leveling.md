---
id: ADR-0008
title: Agent RPG Class & Skill Leveling System
status: Accepted
date: 2026-05-06
---
...
- [ADR 0005 — Tier S/M/L/X authority](ADR-0005-tier-authority-levels.md) — Tier gates that RPG level + skill feed into
- [ADR 0007 — Multi-Provider Subscription Orchestrator](ADR-0007-multi-provider-subscription-orchestrator.md) — MP `routing_policy` consumes RPG `prefer_agent_id` + Tier gates; MP.W0 establishes the canonical `agent_class` schema; MP.W17 ships baseline tool quality that RPG.W13 levels on top of
