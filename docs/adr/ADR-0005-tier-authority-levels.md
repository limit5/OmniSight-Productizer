---
id: ADR-0005
title: Tier S/M/L/X AI authority levels with 4-layer protection
status: Accepted
date: 2026-05-04
---
...
[ADR 0003](ADR-0003-gerrit-code-review.md) establishes the default rule: AI reviewer max +1, human +2 required for merge. Applied uniformly, this means every change — from a `ruff --fix` cleanup to a database schema change — needs a human in the loop.
...
- [ADR 0001 — Git Flow](ADR-0001-five-branch-gitflow.md) — defines branch protection independent of tier
- [ADR 0003 — Gerrit code review](ADR-0003-gerrit-code-review.md) — submit-rule integration point
