...
- When completing a task:
  ...
  - If a generalisable lesson emerged: create a per-file lesson under `docs/sop/lessons/` and run `scripts/build_lessons_index.py` to regenerate `docs/sop/lessons-learned.md` (the index is generated, not hand-edited; vague entries like "be more careful" are auto-rejected per `docs/sop/jira-ticket-conventions.md` §14)
