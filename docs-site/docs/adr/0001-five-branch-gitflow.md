...
- [ADR 0002 — GitLab primary + GitHub mirror](ADR-0002-gitlab-primary-github-mirror.md) — defines where these branches live
- [ADR 0003 — Gerrit code review](ADR-0003-gerrit-code-review.md) — defines how `feature/*` → `develop` merges happen
- [ADR 0005 — Tier S/M/L/X authority](ADR-0005-tier-authority-levels.md) — defines who can promote each branch direction
