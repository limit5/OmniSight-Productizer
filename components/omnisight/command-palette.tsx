...
export function CommandPalette({ onNavigatePanel }: Props) {
  ...
  const commands = useMemo<CommandItem[]>(() => [
    ...
    { id: "new-project", icon: Wand2, label: { en: "New Project / Task", "zh-TW": "新建專案 / 任務", "zh-CN": "新建项目 / 任务", ja: "新規プロジェクト / タスク" }, run: () => { navigatePanel("orchestrator"); setTimeout(() => window.dispatchEvent(new CustomEvent("omnisight:new-project")), 0) }, tags: ["create", "start", "new", "建立", "新增", "開始", "wizard", "describe"] },
