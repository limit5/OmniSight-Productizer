...
export const defaultAgents: Agent[] = [
  {
    ...
    thoughtChain: "Compiling ISP driver for IMX335 sensor...",
    aiModel: "claude-opus-4.6",
    subTasks: [
      { id: "FW-01", name: "Parse sensor manifest", status: "done", duration: "2.3s" },
      { id: "FW-02", name: "Generate ISP config", status: "done", duration: "1.8s" },
      { id: "FW-03", name: "Compile driver module", status: "running" },
      { id: "FW-04", name: "Link dependencies", status: "pending" },
      { id: "FW-05", name: "Package firmware blob", status: "pending" },
    ]
  },
  {
    id: "codec-agent",
    ...
    thoughtChain: "H.265 encoder optimization complete. Awaiting user confirmation.",
    aiModel: "gpt-5.4",
    requiresConfirmation: true,
    history: [
      { id: "h1", action: "Analyzed input stream parameters", result: "success", timestamp: "14:32:01", duration: "0.4s" },
      { id: "h2", action: "Configured H.265 encoder profile", result: "success", timestamp: "14:32:02", duration: "0.2s" },
      { id: "h3", action: "Optimized bitrate allocation", result: "success", timestamp: "14:32:05", duration: "2.8s" },
      { id: "h4", action: "Applied hardware acceleration", result: "success", timestamp: "14:32:08", duration: "1.2s" },
      { id: "h5", action: "Validated output quality", result: "success", timestamp: "14:32:12", duration: "3.5s" },
      { id: "h6", action: "Generated codec configuration", result: "success", timestamp: "14:32:14", duration: "0.6s", output: "codec_config_v2.json" },
    ],
    messages: [
      { id: "m1", type: "info", message: "Starting H.265 encoder optimization", timestamp: "14:32:00" },
      { id: "m2", type: "success", message: "Bitrate target 8Mbps achieved with CRF 23", timestamp: "14:32:08", details: "Quality score: 94.2 VMAF" },
      { id: "m3", type: "action", message: "Generated new codec configuration file", timestamp: "14:32:14", details: "File: codec_config_v2.json (2.4KB)" },
      { id: "m4", type: "warning", message: "B-frame count reduced to maintain latency target", timestamp: "14:32:14" },
    ]
  },
  {
    id: "ai-agent",
    name: "AI_INFERENCE_AGENT",
    type: "software",
    status: "running",
    progress: { current: 3, total: 8 },
    thoughtChain: "Quantizing YOLOv8n model to INT8...",
    aiModel: "gemini-3.1",
    subTasks: [
      { id: "AI-01", name: "Load ONNX model", status: "done", duration: "0.8s" },
      { id: "AI-02", name: "Calibrate quantization", status: "done", duration: "12.4s" },
      { id: "AI-03", name: "Convert to TensorRT", status: "running" },
      { id: "AI-04", name: "Benchmark inference", status: "pending" },
    ]
  },
  {
    id: "validator-agent",
    ...
    thoughtChain: "All validation checks passed. Ready for deployment.",
    aiModel: "claude-sonnet-4.8",
    history: [
      { id: "v1", action: "Verified firmware checksum", result: "success", timestamp: "14:28:01", duration: "0.3s" },
      { id: "v2", action: "Tested sensor initialization", result: "success", timestamp: "14:28:04", duration: "2.1s" },
      { id: "v3", action: "Validated ISP pipeline", result: "success", timestamp: "14:28:08", duration: "3.8s" },
      { id: "v4", action: "Checked power consumption", result: "warning", timestamp: "14:28:15", duration: "5.2s", output: "Peak: 2.3W (target: 2.0W)" },
      { id: "v5", action: "Generated validation report", result: "success", timestamp: "14:28:18", duration: "0.8s", output: "validation_report.pdf" },
    ],
    messages: [
      { id: "vm1", type: "info", message: "Starting validation suite", timestamp: "14:28:00" },
      { id: "vm2", type: "success", message: "All 47 unit tests passed", timestamp: "14:28:10" },
      { id: "vm3", type: "warning", message: "Power consumption 15% above target", timestamp: "14:28:15", details: "Consider enabling low-power mode" },
      { id: "vm4", type: "success", message: "Validation complete - PASS", timestamp: "14:28:18" },
    ]
  },
  {
    id: "reporter-agent",
    ...
    thoughtChain: "Analyzing manifest differences from spec change...",
    aiModel: "grok-3"
  }
]
